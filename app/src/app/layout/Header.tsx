...
export const Header = () => {
  ...
  return (
    <header className="border-border bg-card sticky top-2 z-20 mx-auto flex h-(--header-height) w-full max-w-5xl items-center rounded-2xl border max-md:top-0 max-md:rounded-none max-md:border-x-transparent">
