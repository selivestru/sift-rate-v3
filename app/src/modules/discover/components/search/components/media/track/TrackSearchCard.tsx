...
export const TrackSearchCard = ({ item }: TrackSearchCardProps) => {
  return (
    <Link
      ...
      className="border-border/60 bg-surface/40 hover:border-border hover:bg-surface/70 focus-visible:ring-primary/40 flex items-center gap-3 rounded-xl border px-3 py-2.5 transition-colors duration-200 focus-visible:ring-2 focus-visible:outline-none"
    >
      <span className="bg-foreground/5 text-muted-foreground flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-lg">
        {item.coverUrl ? (
