...
import type { MusicTrackRailItem } from '../types/music-rail.types'
...
export const TrackRail = ({ title, items, className }: TrackRailProps) => {
                ...
                <div className="bg-muted ring-foreground/8 relative aspect-square w-full overflow-hidden rounded-xl ring-1">
                  {item.coverUrl ? (
                    ...
                    <div className="flex size-full items-center justify-center">
                      <Music2Icon className="text-muted-foreground size-8 opacity-60" aria-hidden />
                    </div>
                  )}
                </div>
